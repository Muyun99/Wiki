...
module.exports = {
  ...
  author: {
    ...
    name: 'Muyun99', // 必需
    link: 'https://github.com/Muyun99', // 可选的
  },
  blogger: {
    // 博主信息，显示在首页侧边栏
  ...
  social: {
    // 社交图标，显示于博主信息栏和页脚栏
    iconfontCssFile: '//at.alicdn.com/t/font_2409154_lm62tuw4cvr.css', // 可选，阿里图标库在线css文件地址，对于主题没有的图标可自由添加
    icons: [
      {
        iconClass: 'icon-mail',
        title: '发邮件',
  ...
  footer: {
    ...
    copyrightInfo:
      'Muyun99 | <a href="https://github.com/Muyun99/Wiki/blob/main/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
  },
